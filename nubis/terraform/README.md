...
In these examples the service name is called *nubis-bugzilla*. You will need to choose a unique service name for your deployment as their can only be one *nubis-bugzilla* deployment at a time in one account.
